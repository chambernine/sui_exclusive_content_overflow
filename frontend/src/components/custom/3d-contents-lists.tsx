...
export function ThreeDContentsLists({
  ...
  const images = [
    // Existing images
    "https://images.pexels.com/photos/1366909/pexels-photo-1366909.jpeg?q=80&w=1000",
  ...
  if (isLoading) {
    return (
      <div className="mx-auto w-full rounded-xl bg-gray-950/5 p-2 ring-1 ring-neutral-700/10">
  ...
  return (
    <div className="mx-auto w-full rounded-xl bg-gray-950/5 p-2 ring-1 ring-neutral-700/10 dark:bg-">
